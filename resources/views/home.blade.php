    ...
    <div class="container">
        <header
            ...
            <div class="col-md-3 text-end">
                ...
                @else
                <a href="{{route('dashboard')}}" class="btn btn-sm btn-secondary me-2">Dashboard</a>
                @endguest
            </div>
        </header>
    </div>
    <div class="container py-6">
        <div class="row flex-lg-row-reverse align-items-center g-5">
            ...
            <div class="col-lg-6">
                ...
                <div class="lc-block mb-3">
                    <div editable="rich">
                        <p class="lead">Melalui sistem ini, Anda dapat meinjam kendaraan perusahaan dengan cepat,
                            melacak status peminjaman, serta memastikan kendaraan yang digunakan selalu dalam kondisi
                            prima. Dirancang khusus agar memberikan fleksibilitas dan kemudahan dalam mendukung kegiatan
                            dinas dan tugas sehari-hari.
                        </p>
                    </div>
                </div>

                <div class="lc-block d-grid gap-2 d-md-flex justify-content-md-start">
                    <a class="btn btn-dark px-4 me-md-2"
                        onclick="Swal.fire({title: 'Informasi',text: 'Kamu dapat menemukan panduan Peminjaman setelah kamu login atau register pada platform',icon: 'info',confirmButtonText: 'Oke sip'})"
                        role="button">Panduan</a>
